...
<?php
    ...
    <div class="inner-wrap">
        <label>Adresse e-mail: <input type="email" name="email" value="{{$_SESSION['login']}}" /></label>
    ...
    <div class="inner-wrap">
        ...
        <label>Prénom: <input type="text" name="prenom" value="{{$prenom}}" /></label>
    </div>
